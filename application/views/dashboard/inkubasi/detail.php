		...
		<div class="mx-5 mb-5 pr-5">
			...
			<div class="row no-gutters">
				<div class="col-10 col-sm-5">
					...
					<a href="<?=base_url('dashboard/buatPertemuanCoaching/').$kelas['id_kelas_coaching'];?>" class="text-decoration-none p-1" style="color: #5A47AB; background-color: #bfcbec; border-radius: 5px; font-size: 14px;"><i class="fas fa-fw fa-plus-circle"></i> Buat Pertemuan Coaching</a>
					<?php endif;?>
				</div>
				<div class="col-10 col-sm-6 offset-1">
					<form method="get" action="<?=base_url('dashboard/detailUserInkubasi/').$kelas['id_kelas_coaching'];?>">
			...
			<div class="listPraInkubasi my-5">
				<?php foreach($pertemuan as $pt):?>
					<div class="boxPraInkubasi mb-3" style="border: solid 1.5px #D8D8D8;">
						<label style="color: #5A47AB;font-size: 20px; font-weight: 600; border-bottom: solid 1px #D8D8D8; padding: 1%; background-color: #d8d8d8; margin-bottom: 0;" class="col-12"><?=$pt['nama']?>
							<?php if($this->session->userdata('role_id') != 3):?>
							<span>
								...
								<a class="mr-3" href="<?= base_url('dashboard/editPertemuanInkubasi/').$kelas['id_kelas_coaching'].'/'.$pt['id_pertemuan_kelas'];?>" style="float: right; font-weight: 300; font-size: 12px; text-decoration: none;"><i class="fas fa-fw fa-pen"></i> Edit</a>
							</span>
							<?php endif;?>
						</label>
						<div class="boxDalamPraInkubasi pb-3" style="padding: 1.5%; padding-right: 0; background-color: white; font-size: 14px;">
							<div style="min-height: 200px;">
								...
								<?php foreach($detail as $dt):?>
									...
									<?php elseif($pt['id_pertemuan_kelas'] == $dt['id_pertemuan_kelas'] && $dt['jenis'] == 'link'):?>
										...
										<p style="color: black;"><a href="<?=base_url('dashboard/videoInkubasi/').$dt['id_detail_kelas'];?>" class="text-decoration-none" style="color: black;"><i class="fas fa-fw fa-link mr-2"></i></i><?= $judulLink[0];?></a></p>
...
<!-- <div class="modal fade" id="modalEditPertemuan" tabindex="-1" role="dialog" aria-labelledby="modalEditPertemuanLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?=base_url('dashboard/editPertemuan/').$kelas['id_kelas_coaching'];?>">
				<div class="modal-body">
					<div class="form-group row">
...
<script type="text/javascript">
	...
	function tambahPage($id){
		var id = $id;
		window.location.href = "<?=base_url('dashboard/editPageInkubasi/');?>" + id;
	}
