<div class="container-fluid px-5">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb bg-white" style="font-weight: 300;">
			<li class="breadcrumb-item"><a href="<?=base_url('user');?>" class="text-decoration-none text-muted">Tenant</a></li>
			<li class="breadcrumb-item text-muted" aria-current="page"><?=$tenant['nama_tenant'];?></li>
		</ol>
	</nav>

	<div class="mx-5 mb-5" style="min-height: calc(100vh - 40px);">
		<div class="px-3 py-3 mr-5 bg-white" style="border: solid 1px #d8d8d8; border-radius: 5px; color: #5A47AB;">
			<h3>Detail Tenant</h3>
