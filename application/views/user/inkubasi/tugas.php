<div class="container-fluid px-5">
	...
	<div class="mx-5 mb-5">
		<div class="head-home my-3" style="border: solid 2px; border-color: #FBD15B;">
			<h2 style="font-weight: 500; padding: 5px;">Inkubasi</h2>
		</div>
		...
		<div class="listPraInkubasi my-5">
			...
			<div class="boxPraInkubasi mb-3" style="border: solid 1px #D8D8D8;">
				...
				<div class="boxDalamPraInkubasi" style="padding: 1.5%;">
					...
					<form method="post" action="<?=base_url('user/uploadAssignmentInkubasi/').$detailKelas['id_detail_kelas'].'/'.$progress['id_tenant'];?>" enctype="multipart/form-data">
